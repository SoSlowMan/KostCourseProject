namespace ExampleClient
{
    partial class ExchangeManager
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button2.Click += new System.EventHandler(this.OnAccept);
			// 
			// button1
			// 
			...
			this.button1.Click += new System.EventHandler(this.OnReject);
			// 
			// dgv
			// 
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.ExchangeManager_FormClosed);
			this.Load += new System.EventHandler(this.ExchangeManager_Load);
